...
export const CARD_GAME02_PREFIX = '/api/20250126-card_game02'
...
export const registerCardGame02 = ({ app, server }) => {
  const router = express.Router()

  router.get('/health', (_req, res) => {
    res.json({ ok: true, project: '20250126-card_game02' })
  })

  app.use(CARD_GAME02_PREFIX, router)

  const wss = new WebSocketServer({ noServer: true })
  const wsPath = `${CARD_GAME02_PREFIX}/ws`
