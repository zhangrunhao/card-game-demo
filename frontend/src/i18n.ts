export const messages = {
  en: {
    ...
    'action.rest': 'Rest',
    'action.attack_desc': 'Strike hard to pressure your opponent.',
    'action.defend_desc': 'Brace yourself and reduce losses.',
    'action.rest_desc': 'Recover and prepare for the next exchange.',
  ...
  zh: {
    ...
    'action.defend': '防守',
    'action.rest': '休养',
    'action.attack_desc': '猛烈出击，给对手压力。',
    'action.defend_desc': '稳住阵脚，减少损失。',
    'action.rest_desc': '调整状态，为下回合蓄力。',
    'result.eyebrow': '对局结束',
    'result.draw': '平局',
    'result.victory': '胜利',
    'result.defeat': '失败',
